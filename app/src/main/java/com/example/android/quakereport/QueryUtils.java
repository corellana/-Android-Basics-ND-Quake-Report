...
public final class QueryUtils {
    ...
    // Now, the most important method is this public static method called extractEarthquakes
    // that takes in no inputs and returns an array list of earthquakes.
    public static ArrayList<Earthquake> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to

        // (IE)Within the method, we create an empty array list of earthquakes and return it
        ...
        try {
            ...
            // TODO: Convert SAMPLE_JSON_RESPONSE String into a JSONObject

            // (IE) First, we create the root JSON object by calling the constructor, and passing
            // in the sample JSON response string. This class will parse the whole GL JSON
            ...
            for (int i = 0; i < earthquakesArray.length(); i++){
                ...
                // Create Earthquake java object from magnitude, location, time, and url from the
                // JSON response
